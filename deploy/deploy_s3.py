...
def deploy_to_s3(root_dir, config, region=None):
    ...
    utils_zip_src_path = root_dir + f"/{project_name}/ingestion"
    utils_zip_target_path = (
        root_dir + f"/{project_name}/dependencies/utils"
    )
    connector_zip_src_path = root_dir + f"/{project_name}/ingestion"
    ...
    try:
        ...
        cleanup_cmd = f"aws s3 rm s3://{bucket_name}/{project_name} --recursive"
